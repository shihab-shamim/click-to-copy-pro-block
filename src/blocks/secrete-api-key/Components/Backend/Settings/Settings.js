...
const Settings = ({ attributes, setAttributes }) => {
	...
	return <>
		<InspectorControls>
			...
			<TabPanel className='bPlTabPanel wp-block-ctcb-secret-api-key' activeClass='activeTab' tabs={generalStyleTabs} onSelect={tabController}
			>
				{
					tab => <>
		...
		<BlockControls>
			...
			<AlignmentToolbar value={alignment} onChange={val => setAttributes({ alignment: val })} describedBy={__('Card Alignment', 'b-blocks')} alignmentControls={[
